...
uint8_t keyboard_read_scancode(void)
{
    for (uint8_t i = 0; i < 8; ++i) {
        ...
        // Ignore AUX data (mouse bytes) so mouse movement is not parsed as keys.
        if (status & 0x20U) {
            (void)inb(0x60);
            continue;
        }
...
char keyboard_scancode_to_ascii(uint8_t sc)
{
    switch (sc) {
        ...
        case 0x26: return 'l'; case 0x27: return ';'; case 0x28: return '\''; case 0x2B: return '\\';
        ...
        case 0x34: return '.'; case 0x35: return '/'; case 0x39: return ' '; default: return 0;
    }
}
